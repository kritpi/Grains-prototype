...
- **Tech stack decision** — ✅ closed (2026-09-05). Collapsed from nine open infrastructure topics into three decided pillars: stack architecture, data layer, hosting & auth. See [00_BACKLOG.md](00_BACKLOG.md), with [schema.sql](schema.sql) and [api-surface.md](api-surface.md) as its deliverables.

...
--
-- Hand-written, applied by drizzle-kit. PostGIS DDL is never generated, which
-- is why `pnpm db:generate` is configured --custom and produces an empty file
-- to fill in. lib/db/schema.ts mirrors this and must change alongside it.
--
...
--> statement-breakpoint
CREATE INDEX photobook_items_photo_idx ON photobook_items (photo_id);
--> statement-breakpoint
